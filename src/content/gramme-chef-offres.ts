...
export const OFFRES_CHEF: OffreChef[] = [
  ...
  },
  {
    ...
    contenu: [
      ...
      "Vos prix lus sur vos tickets de caisse et vos factures, mémorisés magasin par magasin (40 photos par mois)",
      "Devis illimités, signés en ligne par le client",
      "Acomptes, factures et relances",
      "Fichier clients et tableau de bord",
      "Ce qui vous reste par heure travaillée, prestation par prestation",
    ],
  },
  {
    id: "chef-pro",
    ...
    contenu: [
      ...
      "Facturation électronique incluse dès son ouverture",
      "Paiement de l'acompte en ligne par carte (courant 2027)",
